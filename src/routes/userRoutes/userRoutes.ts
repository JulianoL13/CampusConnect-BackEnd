...
router.get("/users", authMiddleware.authenticateToken, (req, res) =>
  userController.getUsers(req, res),
);
router.get("/users/cpf/:cpf", authMiddleware.authenticateToken, (req, res) =>
...
router.get("/users/:userId", authMiddleware.authenticateToken, (req, res) =>
